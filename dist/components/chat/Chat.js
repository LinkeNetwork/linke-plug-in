...
function Chat(props) {
    ...
    var roomAddress = props.roomAddress;
    ...
    var handleShowChat = function () {
        if (detectMobile()) {
            window.open("https://www.linke.network/chat/".concat(roomAddress, "/ETHF?share=1"), '_self');
        }
        ...
        !detectMobile() &&
            React.createElement("div", { className: "chat-box ".concat(showChatRoom ? 'collapse-height' : '') },
                React.createElement("div", { className: "chat-item ".concat(isCollapse ? 'chat-item-collapse' : '') },
                    ...
                    !showChatRoom && React.createElement(RoomInfo, { roomAddress: roomAddress, handleShowChat: function () { setShowChatRoom(true); } }),
                    showChatRoom &&
                        React.createElement("iframe", { id: "iframe", ref: _iframe, onLoad: _iframeOnload, src: "https://www.linke.network/chat/".concat(roomAddress, "/ETHF?share=1"), width: "100%", height: "100%", frameBorder: "0" }))),
        showChatRoom && detectMobile() &&
